...
# ==========================================
# [Control Variable] Metrics
# ==========================================
# These functions define how we evaluate the model.
# Do NOT change these if you want comparable results.
...
def visualize_grad_cam(model, image_tensor, saliency_tensor, save_path):
    """
    Helper for visualization. Can be modified if you change the model structure significantly
    and need a different way to extract gradients.
    """
